...
namespace My_DVLD
{
    public partial class frmWrittenTestAppointment : Form
    {
        ...
        public frmWrittenTestAppointment(int LDL_AppID)
        {
        ...
        private void _LoadDataIntoDGV()
        {
            ...
            BS.Filter = $"LocalDrivingLicenseApplicationID = {_LDL_AppID} and TestTypeID = 2";
        ...
        {
            if (clsLocalDrivingLicenseApplication.Find(_LDL_AppID).PassedTestsCount > 1)
            {
