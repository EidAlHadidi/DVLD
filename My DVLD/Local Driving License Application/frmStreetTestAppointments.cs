...
namespace My_DVLD
{
    public partial class frmStreetTestAppointments : Form
    {
        ...
        public frmStreetTestAppointments(int LDL_AppID)
        {
        ...
        private void _LoadDataIntoDGV()
        {
            ...
            BS.Filter = $"LocalDrivingLicenseApplicationID = {_LDL_AppID} and TestTypeID = 3";
        ...
        {
            if (clsLocalDrivingLicenseApplication.Find(_LDL_AppID).PassedTestsCount > 2)
            {
